...
gok = gg.prompt({"Poner Nombre del arquero solo 4 letras iniciales en minúscula - Put the archer's name only 4 initial letters in lowercase"}, {}, {[1] = "text"})
end
...
if gok[1]=='' then gg.toast("♦♦♦ERROR♦♦♦")
	gg.alert("----INGRESE NOMBRE DEL ARQUERO----")
	os.exit()
	end
...
function Mignolet()
 ...
 gg.setRanges(gg.REGION_ANONYMOUS)
	...
	gg.clearResults() 
	print("Hecho por ACL Player")
	print("FOLLOW ME INSTAGRAN  carlvaldivia")
	gg.processResume()
